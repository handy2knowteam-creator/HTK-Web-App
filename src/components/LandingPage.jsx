  ...
  return (
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button 
                  ...
                  className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold text-lg px-8 py-3 h-auto"
                >
                  Find a Tradesperson
                ...
                <Button 
                  onClick={() => navigate('/register/tradesperson')}
                  variant="outline" 
                  className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black text-lg px-8 py-3 h-auto"
                >
                  Join as a Trade
                </Button>
              </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-black/40 backdrop-blur-sm rounded-lg p-4 border border-yellow-400/20">
                    <div className="flex items-center justify-between">
                      <div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-gray-900 via-black to-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-yellow-400/10 border border-yellow-400/30 rounded-full px-6 py-2 mb-4">
              <Star className="h-4 w-4 text-yellow-400 mr-2 fill-current" />
              <span className="text-yellow-400 font-semibold text-sm">WEEKLY SPOTLIGHT</span>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="bg-gradient-to-r from-yellow-400/10 to-yellow-600/10 border-yellow-400/30 overflow-hidden">
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute bottom-4 right-4">
                      <div className="bg-black/80 text-yellow-400 px-3 py-1 rounded-full text-sm font-semibold">
                        +50 Credits Awarded
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-8 flex flex-col justify-center">
                    <div className="mb-6">
                      <h3 className="text-2xl font-bold text-yellow-400 mb-2">Michael Thompson</h3>
                    ...
                    <div className="mb-6">
                      <div className="flex items-center mb-3">
                        ...
                        <span className="text-yellow-400 font-bold text-lg ml-2">5.0</span>
                    ...
                    <div className="mb-6">
                      <h4 className="text-yellow-400 font-semibold mb-2">Latest Customer Review:</h4>
                      <blockquote className="text-gray-300 italic border-l-2 border-yellow-400 pl-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Button className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold flex-1">
                        View Profile
                      </Button>
                      <Button variant="outline" className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black flex-1">
                        Book Now
                      </Button>
                    </div>
                  </div>
            ...
            <div className="mt-12 text-center">
              <Card className="bg-gray-900 border-gray-700 max-w-2xl mx-auto">
                <CardContent className="p-6">
                  <h4 className="text-yellow-400 font-bold text-lg mb-3">🏆 Weekly Competition</h4>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      <div className="text-yellow-400 font-bold">Featured</div>
                  ...
                  <Button className="mt-4 bg-yellow-400/20 text-yellow-400 border border-yellow-400/30 hover:bg-yellow-400 hover:text-black">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-yellow-400/10 border border-yellow-400/30 rounded-full px-6 py-2 mb-4">
              ...
              <span className="text-yellow-400 font-semibold text-sm">BUILT BY TRADES, FOR TRADES</span>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {/* Team Projects */}
            <Card className="bg-gray-900 border-gray-700 hover:border-yellow-400/50 transition-all hover:scale-105">
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 bg-yellow-400/20 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Users className="h-8 w-8 text-yellow-400" />
                </div>
                <h3 className="text-xl font-bold text-yellow-400 mb-4">Team Projects</h3>
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-yellow-400 font-semibold">1,240+</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900 border-gray-700 hover:border-yellow-400/50 transition-all hover:scale-105">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-yellow-400 mb-4">Skill Sharing</h3>
                <p className="text-gray-400 mb-6">
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-yellow-400 font-semibold">450+</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900 border-gray-700 hover:border-yellow-400/50 transition-all hover:scale-105">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-yellow-400 mb-4">Referral Network</h3>
                <p className="text-gray-400 mb-6">
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-yellow-400 font-semibold">2,340</span>
                  </div>
                  <div className="flex items-center justify-between">
          ...
          <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-2xl p-8 text-center">
            ...
            <Button className="bg-black text-yellow-400 hover:bg-gray-900 font-semibold px-8 py-3">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="bg-gray-900 border-gray-700 hover:border-yellow-400/50 transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {trades.map((trade, index) => (
              <Card key={index} className="bg-gray-900 border-gray-700 hover:border-yellow-400/50 transition-all hover:scale-105 cursor-pointer">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-yellow-400/20 rounded-lg flex items-center justify-center">
                        <trade.icon className="h-5 w-5 text-yellow-400" />
                      </div>
                      <div>
      ...
      <section className="py-16 bg-gradient-to-r from-gray-900 to-black border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-yellow-400 mb-4">Featured Partners</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-gray-900 border-gray-700 hover:border-yellow-400 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-yellow-400 font-semibold text-lg mb-2">Premium Sponsor</h3>
                ...
                <div className="bg-yellow-400/10 border border-yellow-400/30 rounded-lg p-3">
                  <p className="text-yellow-400 text-xs font-medium">SPONSORSHIP AVAILABLE</p>
            ...
            <Card className="bg-gray-900 border-gray-700 hover:border-yellow-400 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-yellow-400 font-semibold text-lg mb-2">Trade Partner</h3>
                <p className="text-gray-400 text-sm mb-4">Showcase your tools, materials, or services to our verified tradesperson network.</p>
                <div className="bg-yellow-400/10 border border-yellow-400/30 rounded-lg p-3">
                  <p className="text-yellow-400 text-xs font-medium">PARTNERSHIP OPPORTUNITY</p>
            ...
            <Card className="bg-gray-900 border-gray-700 hover:border-yellow-400 transition-colors">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-yellow-400 font-semibold text-lg mb-2">Industry Leader</h3>
                <p className="text-gray-400 text-sm mb-4">Position your brand as a leader in the trades industry with premium placement.</p>
                <div className="bg-yellow-400/10 border border-yellow-400/30 rounded-lg p-3">
                  <p className="text-yellow-400 text-xs font-medium">FEATURED PLACEMENT</p>
          ...
          <div className="text-center mt-12">
            <Card className="bg-gradient-to-r from-yellow-400 to-yellow-600 border-none max-w-2xl mx-auto">
              <CardContent className="p-6">
                ...
                <Button className="bg-black text-yellow-400 hover:bg-gray-900 font-semibold">
      ...
      <section className="py-16 px-6 bg-gray-900">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold text-yellow-400 mb-8 text-center">Get started with HTK</h2>
          
          <Card className="bg-black border-gray-700">
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <Label htmlFor="name" className="text-yellow-400 mb-2 block">Name</Label>
                  <Input
                    id="name"
                    value={formData.name}
                    onChange={(e) => setFormData(prev => ({ ...prev, name: e.target.value }))}
                    className="bg-gray-900 border-gray-600 text-white focus:border-yellow-400"
                    required
                  />
                </div>
                ...
                <div>
                  <Label htmlFor="role" className="text-yellow-400 mb-2 block">Role</Label>
                  <Select onValueChange={(value) => setFormData(prev => ({ ...prev, role: value }))}>
                    <SelectTrigger className="bg-gray-900 border-gray-600 text-white focus:border-yellow-400">
      ...
      <footer className="py-8 px-6 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-400 text-sm">
            ...
            <a href="mailto:Cotswold.morganmaintenance@gmail.com" className="text-yellow-400 hover:text-yellow-300 ml-1">
